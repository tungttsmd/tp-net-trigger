...
@ModuleAnnotation
public final class LaunchDeviceTypeModule implements CommandModule {
    ...
    public void handle(CommandContext ctx) {
        try {
            ...
            runtime.addProperty("device-type", ConfigService.HOST_DEVICE_TYPE());
