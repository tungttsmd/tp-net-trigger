...
:: ============================================================
::  BUILD SCRIPT: WinTtSvc
:: ============================================================

set "ROOT_DIR=%~dp0"
set "MODULE_DIR=%ROOT_DIR%WinTtSvc"
...
set "APP_NAME=WinTtSvc"
set "JAR_NAME=WinTtSvc-1.0.0.jar"
...
echo.
cd /d "%ROOT_DIR%"
call mvn clean package -pl WinTtSvc -am -DskipTests
if errorlevel 1 (
    echo.
